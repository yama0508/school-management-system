                       ...
                       <div class="col-12">	
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <h5>Firther's Name <span class="text-danger">*</span></h5>
                                    <div class="controls">
 ...
 <div class="row">
                ...
                <select name="year_id" id="" required="" class="form-control">
                    <option value="" selected="" disabled="">Select Year</option>
                        ...
                        @foreach ($years as $year)
                            <option value="{{$year->id}}" {{($editData->year_id==$year->id)?
            ...
            <div class="controls">
                <select name="class_id" id="" required="" class="form-control">
                    ...
                    @foreach ($classes as $class)
                            <option value="{{$class->id}}" {{($editData->class_id==$class->id)?
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <select name="group_id" id="" required="" class="form-control">
                    <option value="" selected="" disabled="">Select Group</option>

                    @foreach ($groups as $group)
                    <option value="{{$group->id}}" {{($editData->group_id==$group->id)?
                ...
                <select name="shift_id" id="" required="" class="form-control">
                    <option value="" selected="" disabled="">Select Shift</option>
                        ...
                        @foreach ($shifts as $shift)
                            <option value="{{$shift->id}}" {{($editData->shift_id==$shift->id)?
